modded class InfluenzaMdfr : ModifierBase
{
	...
	private const int COUGH_RND_DIVIDER_NORMAL_MIN 		= 10;
	private const int COUGH_RND_DIVIDER_NORMAL_MAX 		= 40;
	private const int COUGH_RND_DIVIDER_SUPPRESSED_MIN 	= 20;
	private const int COUGH_RND_DIVIDER_SUPPRESSED_MAX 	= 80;
